...
export default function HomePage() {
    ...
    useEffect(() => {
        ...
        // If no role is set, we'll handle the redirect in the render logic below
    }, []);
    ...
    // If user is authenticated but has no role set, redirect to login to select a role
    if (user && userRole === null) {
        // Don't render anything while checking for role
        return (
            <div className="min-h-screen bg-gray-900 flex items-center justify-center">
                <div className="text-white text-center">
                    <Loader className="animate-spin h-8 w-8 mx-auto mb-4" />
    ...
    return (
        <main className="relative w-full h-screen flex flex-col bg-gray-900 -z-10">
            <Header
