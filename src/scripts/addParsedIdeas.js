// This script can be run from the command line to add the parsed ideas to the database
// Usage: node src/scripts/addParsedIdeas.js

import { addParsedIdeasToDB } from '../lib/addParsedIdeasToDB.js';
